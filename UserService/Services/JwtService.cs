...
namespace UserService.Services
{
    public class JwtService : IJwtService
    {
        ...
        public JwtService(UserServiceContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public async Task<AuthResponse> GetRefreshTokenAsync(UserRequest request)
        {
            ...
            var accessToken = GenerateAccessToken(request.UserEmail, request.Id, request.Roles);
        ...
        public async Task<AuthResponse> GetTokenAsync(UserRequest request)
        {
            ...
            AccessToken accessToken = GenerateAccessToken(user.Email, user.Id, user.UserRoles?.Select(role => role.Role.RoleName).ToArray());
        ...
        private AccessToken GenerateAccessToken(string email, int id, string[] roles)
        {
